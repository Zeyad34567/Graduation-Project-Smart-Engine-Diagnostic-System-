...
This notebook trains the binary Out-Of-Distribution (OOD) gate Random Forest model and exports `ood_gate_rf_v1.json`.
...
### 3.6 Model Export Pipeline (already executed — outputs included in `app6/assets/`)

Each notebook ends by:
